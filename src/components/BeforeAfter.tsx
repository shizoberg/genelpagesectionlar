        ...
        <div className="k5-reveal d2 grid grid-cols-[1fr_auto_1fr] items-stretch gap-2 sm:gap-3 max-w-2xl mx-auto">
          <div className="bg-secondary/60 rounded-2xl p-3 sm:p-5 border border-border">
            ...
            <ul className="space-y-1.5 sm:space-y-2.5">
              {before.map((item) => (
                <li key={item} className="flex items-start gap-1.5 sm:gap-2 text-[11px] sm:text-sm text-muted-foreground leading-tight">
                  <span className="w-3.5 h-3.5 sm:w-5 sm:h-5 rounded-full bg-rose/15 flex items-center justify-center flex-shrink-0 text-rose mt-0.5">
          ...
          <div className="bg-secondary/60 rounded-2xl p-3 sm:p-5 border border-primary/30">
            <p className="text-[10px] sm:text-xs font-bold uppercase tracking-wider text-primary mb-2 sm:mb-3">
              Sonra
            </p>
            <ul className="space-y-1.5 sm:space-y-2.5">
              {after.map((item) => (
                <li key={item} className="flex items-start gap-1.5 sm:gap-2 text-[11px] sm:text-sm text-foreground font-medium leading-tight">
                  <span className="w-3.5 h-3.5 sm:w-5 sm:h-5 rounded-full bg-sage/20 flex items-center justify-center flex-shrink-0 text-sage mt-0.5">
